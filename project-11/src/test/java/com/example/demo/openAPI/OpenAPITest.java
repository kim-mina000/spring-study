...
public class OpenAPITest {
	...
	String serviceKey="%2FaIUuHGuxYLP23e0F5fUdUn5IVxYwkJ2W5YLyjSsye07%2Fl06SIJZPkAtiDZPUreo94KAHXvKAq2JjqJKNRIDqw%3D%3D";
	String dataType="JSON";
	String code="11B20201";
	
	// 날씨 예보 API를 호출하는 테스트
//	@Test
//	@ Test 롬복을 지우고 void-> String으로 바꿔서 일반 메소드로 정의
